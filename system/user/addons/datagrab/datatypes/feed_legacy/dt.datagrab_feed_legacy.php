 ...
 */
class Datagrab_feed_legacy extends AbstractDataTypeLegacy
{
    ...
    function get_item($item, $id): string
    {
        if (strpos($id, ':')) {
    ...
    public function get_sub_item(array $item, string $key, array $config = [], string $field = '', array $column = [])
    {
        ...
        return $this->get_item($item, $key . $suffix);
    }
