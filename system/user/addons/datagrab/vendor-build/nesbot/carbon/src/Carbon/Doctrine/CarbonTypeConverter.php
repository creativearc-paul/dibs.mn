...
use BoldMinded\DataGrab\Dependency\Doctrine\DBAL\Types\ConversionException;
use Exception;
/**
...
trait CarbonTypeConverter
{
    ...
    {
        $precision = ($fieldDeclaration['precision'] ?: 10) === 10 ? DateTimeDefaultPrecision::get() : $fieldDeclaration['precision'];
