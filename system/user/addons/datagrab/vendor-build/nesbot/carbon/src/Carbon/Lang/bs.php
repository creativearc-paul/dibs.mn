...
}, 'lastDay' => '[jučer u] LT', 'lastWeek' => function (\BoldMinded\DataGrab\Dependency\Carbon\CarbonInterface $current) {
    switch ($current->dayOfWeek) {
        case 0:
        case 3:
