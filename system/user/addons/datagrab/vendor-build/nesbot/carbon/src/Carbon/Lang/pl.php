...
}, 'lastDay' => '[Wczoraj o] LT', 'lastWeek' => function (\BoldMinded\DataGrab\Dependency\Carbon\CarbonInterface $date) {
    switch ($date->dayOfWeek) {
        case 0:
