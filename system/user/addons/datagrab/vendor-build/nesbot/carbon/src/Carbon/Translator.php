...
class Translator extends Translation\Translator
{
    ...
    public function setMessages($locale, $messages)
    {
        ...
        $this->messages[$locale] = \array_merge(isset($this->messages[$locale]) ? $this->messages[$locale] : [], $messages);
        return $this;
    }
    /**
    ...
    public function setLocale($locale)
    {
        ...
        if (\strpos($locale, '_') !== \false && $this->loadMessagesFromFile($macroLocale = \preg_replace('/^([^_]+).*$/', '$1', $locale))) {
