...
use BoldMinded\DataGrab\Dependency\League\Csv\Query;
...
final class Column implements Query\Predicate
{
     ...
     */
    private function __construct(public readonly string|int $column, public readonly Comparison|Closure $operator, public readonly mixed $value)
    {
     ...
     * @throws Query\QueryException
     */
    public static function filterOn(string|int $column, Comparison|Closure|callable|string $operator, mixed $value = null) : self
    {
        ...
        return new self($column, \is_string($operator) ? Comparison::fromOperator($operator) : $operator, $value);
    }
    /**
