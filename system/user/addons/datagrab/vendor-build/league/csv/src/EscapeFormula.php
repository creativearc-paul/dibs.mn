...
class EscapeFormula
{
     ...
     */
    public function __construct(protected string $escape = "'", array $special_chars = [])
    {
        $this->special_chars = array_fill_keys([...self::FORMULA_STARTING_CHARS, ...$this->filterSpecialCharacters(...$special_chars)], 1);
    }
    /**
    ...
    protected function escapeField(mixed $cell) : mixed
    {
        ...
        return match (\true) {
            null == $strOrNull, !isset($strOrNull[0], $this->special_chars[$strOrNull[0]]) => $cell,
    ...
    protected function unescapeField(mixed $cell) : mixed
    {
        ...
        return match (\true) {
            null === $strOrNull, !isset($strOrNull[0], $strOrNull[1]), $strOrNull[0] !== $this->escape, !isset($this->special_chars[$strOrNull[1]]) => $cell,
