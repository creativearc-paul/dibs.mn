...
use BoldMinded\DataGrab\Dependency\League\Csv\Query\SortCombinator;
...
final class MultiSort implements SortCombinator
{
    ...
    {
        $this->sorts = array_map(static fn(Sort|Closure|callable $sort): Sort|Closure => $sort instanceof Closure || $sort instanceof Sort ? $sort : $sort(...), $sorts);
    }
    /**
     * @param OrderingExtended ...$sorts
     */
