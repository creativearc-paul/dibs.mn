...
final class MappingFailed extends LogicException implements SerializationFailed
{
    ...
    public static function dueToTypeCastingUnsupportedType(ReflectionProperty|ReflectionParameter $reflectionProperty, TypeCasting $typeCasting, string ...$types) : self
    {
