...
final class Offset implements Query\Predicate
{
     ...
     */
    private function __construct(public readonly Comparison|Closure $operator, public readonly mixed $value)
    {
     ...
     * @throws Query\QueryException
     */
    public static function filterOn(Comparison|Closure|callable|string $operator, mixed $value = null) : self
    {
        ...
        return new self(\is_string($operator) ? Comparison::fromOperator($operator) : $operator, $value);
    }
    /**
     * @throws Query\QueryException
     */
