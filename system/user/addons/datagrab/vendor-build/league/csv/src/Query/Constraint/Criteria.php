...
use BoldMinded\DataGrab\Dependency\League\Csv\Query\PredicateCombinator;
...
final class Criteria implements PredicateCombinator
{
    ...
    {
        return new self(fn(mixed $value, int|string $key): bool => array_reduce($predicates, fn(bool $bool, Predicate|Closure|callable $predicate) => $predicate($value, $key) xor $bool, \false));
    }
