...
final class FrenchInflector implements InflectorInterface
{
    ...
    private const PLURALIZE_REGEXP = [
        ...
        // French titles
        ['/^(mon|ma)(sieur|dame|demoiselle|seigneur)$/', 'BoldMinded\\DataGrab\\Dependency\\mes\\2s'],
        ['/^(Mon|Ma)(sieur|dame|demoiselle|seigneur)$/', 'BoldMinded\\DataGrab\\Dependency\\Mes\\2s'],
    ];
    /**
    ...
    private const SINGULARIZE_REGEXP = [
        ...
        // French titles
        ['/^mes(dame|demoiselle)s$/', 'BoldMinded\\DataGrab\\Dependency\\ma\\1'],
        ['/^Mes(dame|demoiselle)s$/', 'BoldMinded\\DataGrab\\Dependency\\Ma\\1'],
        ['/^mes(sieur|seigneur)s$/', 'BoldMinded\\DataGrab\\Dependency\\mon\\1'],
        ['/^Mes(sieur|seigneur)s$/', 'BoldMinded\\DataGrab\\Dependency\\Mon\\1'],
        // Default rule
        ['/s$/i', ''],
    ];
