...
namespace BoldMinded\DataGrab\Dependency\Doctrine\Inflector\Rules\Spanish;
...
class Inflectible
{
    ...
    {
        (yield new Transformation(new Pattern('/ú([sn])$/i'), 'BoldMinded\\DataGrab\\Dependency\\u\\1es'));
        (yield new Transformation(new Pattern('/ó([sn])$/i'), 'BoldMinded\\DataGrab\\Dependency\\o\\1es'));
        (yield new Transformation(new Pattern('/í([sn])$/i'), 'BoldMinded\\DataGrab\\Dependency\\i\\1es'));
        (yield new Transformation(new Pattern('/é([sn])$/i'), 'BoldMinded\\DataGrab\\Dependency\\e\\1es'));
        (yield new Transformation(new Pattern('/á([sn])$/i'), 'BoldMinded\\DataGrab\\Dependency\\a\\1es'));
